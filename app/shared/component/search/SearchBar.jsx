...
const Search = () => {
  ...
  return (
    <div className="relative flex flex-col items-center lg:w-[560px] md:w-96 min-w-64">
      <div className="relative w-full">
        ...
        <input
          ...
          role="searchbox"
          autoComplete="off"
          className="h-11 w-full overflow-hidden rounded-full border border-solid text-[#1c284d] border-[#1c284d] pl-10 pr-3 focus:bg-[#eae8ff] focus:outline-none text-[17px] font-semibold"
