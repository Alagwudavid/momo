...
const SidebarCategory = () => {
  ...
  return (
    <div className="flex flex-col items-center" onMouseLeave={handleMouseLeave}>
      <div className="relative border-[1px] rounded-lg mt-5 bg-[#eae8ff] font-semibold">
      ...
      <div className="relative border-[1px] rounded-lg mt-5 px-6 py-2 text-[14px] block text-center bg-[#eae8ff] font-semibold">
