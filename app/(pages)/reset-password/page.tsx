...
export default function ResetPassword () {
    return (
        ...
        <div className="mb-3">
            ...
            <p className="text-sm text-left text-gray-700">If E-mail is linked to an account,<br /> you will receive a five digit code in you inbox</p>
        </div>
        <form className="flex flex-col gap-2">
            ...
            />
            <Link href="/reset-password" className="w-full flex flex-row flex-wrap justify-center font-semibold p-2 rounded bg-slate-900 text-white hover:bg-slate-800">
                Send Code
            </Link>
            </div>
            <div className="flex flex-row justify-between gap-2">
            <input type="number" name="Verification-code" autoComplete="on" required
            className="h-[40px] w-full overflow-hidden rounded-md border border-solid text-[#1c284d] p-2 bg-white focus:outline-none text-[14px]"
            placeholder="01234"
            />
            <Link href="/reset-password" className="w-full flex flex-row flex-wrap justify-center font-semibold p-2 rounded bg-slate-900 text-white hover:bg-slate-800">
