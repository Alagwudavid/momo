...
const Footer = () => {
  return (
    <>
      <div className="mx-auto mt-[46px] max-w-screen-2xl px-5 py-6 lg:px-8 bg-black text-white h-auto">
        <div className="flex flex-col gap-3 sm:grid sm:grid-cols-footer mx-auto text-[16px] h-auto">
          <div className="flex flex-col cursor-default sm:w-[240px]">
            <Image
              ...
              height={40}
            />
            <div className="text-[15px] mt-2 flex flex-row flex-wrap gap-1">
              We are here to make <br /> e-commerce easier and <br /> cost
              effective for Students in Nigeria.
            </div>
            <div className="text-[12px] mt-3 flex flex-row gap-2 items-center">
              Powered by
